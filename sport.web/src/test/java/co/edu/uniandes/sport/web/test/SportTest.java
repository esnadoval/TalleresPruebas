package co.edu.uniandes.sport.web.test;
...
public class SportTest {
    ...
    public void testCreateSport() throws Exception {
        //Comando que indica al navegador ir a la dirección de la página web (localhost:8080/sport.web)
        driver.get(baseUrl + "/sport.web/");
        //Comando que realiza click sobre el boton "create" del toolbar. La función 'find' encuentra el control 
        //y posteriormente hace clic en el mismo. La forma en la que se busca  el control es utilizando expresiones xPath ya que
        // los id de los mismos nucna son iguales (se generan con junto con el valor de componentId que varía).
        ...
        //Comando que simula la escritura de un valor en el elemento(sendKeys) con el String de parámetro sobre
       ...
       //Comandos para llenar el campo minAge
        ...
        //Comando que encuentra y hace clic sobre el boton "Save" del toolbar (una vez mas encontrado por una expresión Xpath)
        ...
        Thread.sleep(2000);
        // Comando que obtiene el div azul de creación exitosa. Si se obtiene, la prueba va bién, si no, saldrá un error y la prueba quedará como fállida.
        WebElement dialog = driver.findElement(By.xpath("//div[contains(@style,'display: block;')]"));
        // Comando que obtiene la tabla con el elemento que se creó anteriormente.
        List<WebElement> table = driver.findElements(By.xpath("//table[contains(@class,'table striped')]/tbody/tr"));
        boolean fail = false;
       //Se itera sobre los elementos de la tabla para ver si el nuevo elento creadoEstá en la lista
        ...
        // la prueba es exitosa si se encontró el dialogo de creación exitosa y el nuevo elemento está en la lista.
